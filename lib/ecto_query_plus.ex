defmodule EctoQueryPlus do
  ...
  defmacro __using__(_opts) do
    quote do
      ...
      defdelegate wherep(struct, filters), to: EctoQueryPlus
      defdelegate offsetp(struct, filters), to: EctoQueryPlus
      defdelegate limitp(struct, filters), to: EctoQueryPlus
      defdelegate selectp(struct, filters), to: EctoQueryPlus
      defdelegate order_byp(struct, filters), to: EctoQueryPlus
      defdelegate preloadp(struct, filters), to: EctoQueryPlus
    end
  end
end
